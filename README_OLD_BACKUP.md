...
A fully functional Flutter-based e-commerce application recreating the University of Portsmouth Student Union shop. This project demonstrates comprehensive implementation of modern Flutter development practices, state management, authentication, and responsive design.

## 🌟 Project Overview

This Flutter application is a comprehensive recreation of the [University of Portsmouth Student Union Shop](https://shop.upsu.net), featuring:

- **Full E-Commerce Functionality**: Browse products, manage shopping cart, and place orders
- **User Authentication System**: Complete login/signup with persistent sessions using SharedPreferences
- **Responsive Design**: Optimized for both mobile and desktop viewports
- **State Management**: Provider pattern for efficient state handling across the app
- **Navigation**: GoRouter implementation with route guards and deep linking support
- **Custom Features**: Print Shack for product personalization
- **Comprehensive Testing**: Over 120+ tests covering services, models, and UI components

### 📸 Application Features

The application includes 20+ unique products across 4 categories (Clothing, Accessories, Souvenirs, Stationery), with full shopping cart functionality, user account management, and order tracking.
